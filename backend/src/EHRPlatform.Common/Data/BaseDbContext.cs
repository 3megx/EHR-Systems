...
public abstract class BaseDbContext : DbContext
{
    ...
    protected virtual void ConfigureAuditableEntity(ModelBuilder modelBuilder)
    {
        ...
        foreach (var entityType in auditableTypes)
        {
            ...
            // Store PII access levels
            modelBuilder.Entity(clrType)
                .Property("PiiAccessLevel")
                .HasMaxLength(50);
        }
    }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            foreach (var entry in entries)
            {
                ...
                if (entry.Entity is AuditableEntity auditableEntity)
                {
                    ...
                    if (string.IsNullOrEmpty(auditableEntity.CreatedBy) && entry.State == EntityState.Added)
                    {
                    ...
                    {
                        auditableEntity.ModifiedBy ??= "SYSTEM";
                    }
                }
            }
